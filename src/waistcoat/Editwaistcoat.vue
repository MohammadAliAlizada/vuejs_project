<template>
  <div>
    ...
    <!-- <b-btn v-b-modal.modalPrevent size="sm" variant="primary"  @click="mywaistcoat"><i class="plus icon" style="margin-left:5px;"></i>واسکت جدید</b-btn> -->
      <a  v-b-modal.modalPrevent class="btn edit ng-star-inserted" style="margin-left:4px;" @click="mywaistcoat" >
  ...
  <button class=" mini ui positive button rad" @click="handleOk" >Update</button>
  <div class="or"></div>
...
export default {
  ...
  methods: {
    mywaistcoat(){
        this.waistcoat.customer_id = this.editwaistcoat.customer_id;
        this.waistcoat.height = this.editwaistcoat.height;
        this.waistcoat.shoulder = this.editwaistcoat.shoulder;
        this.waistcoat.chest = this.editwaistcoat.chest;
        this.waistcoat.waist = this.editwaistcoat.waist;
        this.waistcoat.seat = this.editwaistcoat.seat;
        this.waistcoat.neck = this.editwaistcoat.neck;
        this.waistcoat.armpit = this.editwaistcoat.armpit;
        this.waistcoat.total = this.editwaistcoat.total;
        this.waistcoat.order  = this.editwaistcoat.order;
        this.waistcoat.received = this.editwaistcoat.received;
        this.waistcoat.minus = this.editwaistcoat.minus;
        if(this.editwaistcoat.isComplete == "آماده تحویل"){
        ...
        if(this.editwaistcoat.breastDesign == "یک سینه ای"){
        ...
        if(this.editwaistcoat.skirtDesign == "راست"){

            this.waistcoat.skirtDesign = 1;

        }else if(this.editwaistcoat.skirtDesign == "گول"){
        ...
        if(this.editwaistcoat.neckDesign == "هفت"){

            this.waistcoat.neckDesign = 1;

        }else if(this.editwaistcoat.neckDesign == "گرد"){

            this.waistcoat.neckDesign = 2;

        }else if(this.editwaistcoat.neckDesign == "پاکستانی"){
        ...
        this.waistcoat.start_date = this.editwaistcoat.start_date;
        this.waistcoat.end_date = this.editwaistcoat.end_date;
    ...
    handleSubmit () {
       this.axios.defaults.headers.common["Authorization"] = 'Bearer ' + localStorage.getItem('token');
           this.axios.patch('/waistcoats/'+this.id , this.$data.waistcoat)
           .then((response) => {
